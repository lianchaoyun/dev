...
export default {
  ...
  methods: {
    ...
    post() {
      ...
      let data = {
        post_title: this.form.title || this.form.auto.title,
        post_excerpt: this.form.desc || this.form.auto.desc,
        post_content: this.editor.getValue(0),
        post_cover: this.form.thumb || this.form.auto.thumb,
      }
